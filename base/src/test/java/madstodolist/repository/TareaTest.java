...
public class TareaTest {
    ...
    @Test
    public void crearTareaConPrioridad() {
        // GIVEN
        // Un usuario nuevo creado en memoria, sin conexión con la BD,
        ...
        Tarea tarea = new Tarea(usuario, "Práctica 1 de MADS", "ALTA");
    ...
    @Test
    public void crearTareaSinPrioridad() {
        // GIVEN
        // Un usuario nuevo creado en memoria, sin conexión con la BD,
    ...
    public void cambioPrioridad() {
        ...
        Tarea tareaBD = tareaRepository.findById(tareaId).orElse(null);
        assertThat(tareaBD.getPrioridad()).isEqualTo(tarea.getPrioridad());
    }
}
